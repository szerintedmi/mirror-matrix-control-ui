...
const UnassignedMotorTray: React.FC<UnassignedMotorTrayProps> = ({
    ...
    const renderGroupList = (list: UnassignedGroup[], className = '') => (
    ...
    return (
        <div
            className={`rounded-lg border border-gray-700 bg-gray-800/60 p-3 transition-colors ${
                isDropHovering ? 'border-red-500/70 bg-red-900/30' : ''
            }`}
        ...
        >
            ...
            {hasGroups ? (
                ...
                <div className="mt-3 rounded-md border border-dashed border-gray-600 bg-gray-900/40 px-4 py-3 text-sm text-gray-400">
