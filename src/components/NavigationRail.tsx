...
const NavigationRail: React.FC<NavigationRailProps> = ({
    ...
    return (
        ...
        >
            <nav className="flex size-full flex-col justify-between overflow-y-auto py-6">
                    ...
                    <ul className="flex flex-col gap-1">
                        ...
                        {legacyItems.length > 0 && (
                            <li className="mt-2 border-t border-gray-800 pt-2">
                                ...
                                >
                                    <span className="flex size-9 items-center justify-center rounded-md bg-gray-800 text-gray-500 group-hover:text-gray-300">
                                        <svg
