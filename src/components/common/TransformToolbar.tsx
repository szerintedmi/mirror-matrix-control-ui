...
export interface TransformToolbarProps {
    /** Called when shift transform is requested */
    onShift: (dx: number, dy: number) => void;
    /** Called when scale transform is requested */
    onScale: (scaleX: number, scaleY: number) => void;
    /** Called when rotate transform is requested */
...
const TransformToolbar: React.FC<TransformToolbarProps> = ({
    ...
    return (
        <div className="flex flex-wrap items-center gap-4 rounded-md border border-gray-700/50 bg-gray-800/30 p-2 text-xs">
            {/* Shift Controls */}
