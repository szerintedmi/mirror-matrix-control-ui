var cv = (() => {
    ...
    return async function (moduleArg = {}) {
        ...
        function findWasmBinary() {
            return locateFile('opencv_js.wasm');
        }
        ...
        function assignWasmExports(wasmExports) {
            ...
            __indirect_function_table = wasmTable = wasmExports['_'];
        }
        var wasmImports = {
            g: ___cxa_throw,
            ...
            z: __embind_register_value_array_element,
...
} else if (typeof define === 'function' && define['amd']) define([], () => cv);
